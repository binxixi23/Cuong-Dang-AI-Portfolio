...
## Course Overview
This directory houses my engineering case studies, domain-specific research reports, and technical reflections analyzing the integration of Artificial Intelligence into industry. The coursework spans enterprise software pipelines, autonomous infrastructure design, risk management, and the ethical guardrails required for deployment in modern sectors.
...
* **[Module 01 & 02](./Module%2001%20Philosophy%20and%20AI%20%26%20Ethical%20and%20Societal%20Implications%20of%20AI/)**: Philosophy, Ethics, & Generative AI
...
## Technical & Structural Frameworks Evaluated
* **Data Pipelines**: Stream processing, automated feature mapping, anomaly isolation, and architectural flowcharts.
* **Core Models Reviewed**: Transformer LLM structures, Convolutional Networks, and Autonomous Financial Shields.
* **System Metrics**: Latency minimization, false-positive thresholds, risk profiling, and regulatory compliance.

---

## How to Review This Directory
1. Navigate into specific module folders to review domain-specific technical documentation and case study reports.
2. Open the comprehensive `.pdf` summaries (e.g., `A04_group_Cuong_Dang_ITAI 2372.pdf`) for complete system breakdowns.
3. Functional architectural diagrams, pipeline flows, and trend graphs are hosted inside their respective module folders as high-resolution image files.
