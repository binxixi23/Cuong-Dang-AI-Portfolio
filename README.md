# Cuong Dang - Applied AI & Robotics Portfolio

## About Me
I am an Applied AI and Robotics student specializing in end-to-end data preparation pipelines, classical supervised machine learning models, convolutional neural network architectures, and industry-specific AI automation frameworks. This portfolio tracks my technical development, core engineering competencies, and project executions.

## Technical Skills
* **Programming Languages**: Python (3.x)
* **Libraries & Frameworks**: NumPy, Pandas, Matplotlib, Seaborn, Scikit-Learn, OpenCV, TensorFlow, Keras, PyTorch
* **Development Environments**: Google Colab, Jupyter Notebooks, Git, GitHub, Windows Command Line
* **Core AI Competencies**: Exploratory Data Analysis (EDA), Feature Engineering, Computer Vision Pipeline Design, Anomaly Detection Modeling, Model Evaluation & Regularization
...
* **Directory**: [./ITAI_2372_Artificial_Intel_Applications/](./ITAI_2372_Artificial_Intel_Applications/)
* **Featured Case Study**: [AI Driven Financial Fraud Detection Shield](./ITAI_2372_Artificial_Intel_Applications/Module%2004%20AI%20in%20Finance/)
...
```text
Cuong-Dang-AI-Portfolio/
├── README.md                                          # Main Portfolio Homepage (This File)
│
├── ITAI-1371-Intro-to-Machine-Learning/               # Machine Learning Coursework
│   ├── README.md                                      # Course Index
│   ├── Midterm/                                       # Telco Customer Churn Project
│   └── Module 01 ... Module 08/                       # Lab Work & Journals
│
├── ITAI-1378-Computer-Vision/                         # Computer Vision Coursework
│   ├── README.md                                      # Course Index
│   ├── FINAL-PROJECT/                                 # SentinelClean Capstone
│   ├── Midterm, Final Project ... Instructions/       # Project Setup Guides & Rubrics
│   └── Module 01 ... Module 06/                       # CNN & YOLO Lab Notebooks
│
└── ITAI-2372-AI-Applications/                         # AI Applications Coursework
    ├── README.md                                      # Course Index
    └── Module 01 ... Module 12/                       # Cross-Industry Case Studies & Reports
```
